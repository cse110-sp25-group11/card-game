...
describe("Loading Home Page", () => {
    ...
    it("Initial Home Page - Like Button Functionality", async () => {
        ...
        console.log(
            `Liked Events: before = ${initialCount}, after = ${updatedCount}`,
        );
    ...
    it("Initial Home Page - Disike Button Functionality", async () => {
        ...
        console.log(
            `DisLiked Events: before = ${initialCount}, after = ${updatedCount}`,
        );
    ...
    it("Initial Home Page - Checking Undo Button", async () => {
        ...
        const newCounterVal = await page.$eval(
            "#counterText",
            (el) => el.textContent,
        );
    ...
    it("Check liked events page", async () => {
        ...
        await page.goto(
            "https://cse110-sp25-group11.github.io/card-game/liked.html",
        );
